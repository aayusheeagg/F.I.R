...
$link = mysql_connect("localhost", "root", "");
	 ...
	 echo"       <p align=\"right\"><a href=\"adminlogout.php\">LogOut</a></p>";
		 ...
		 //echo"$ffno";
		 //echo"$top";
			$cnt=mysql_query("select firs.copid,firstatus.firno,firstatus.status,filerdetails.name,firstatus.topic,firs.todaydate,firstatus.closeddate from filerdetails,firs,firstatus where firstatus.firno=filerdetails.firno and filerdetails.firno=firs.firno and firstatus.firno=\"$ffno\"");
