...
$link = mysql_connect("localhost", "root", "");
	 ...
	 echo"       <p align=\"right\"><a href=\"coplogout.php\">LogOut</a></p>";
		 ...
		 $_SESSION['chk']=0;
			...
			$cnt=mysql_query("select * from firs where firno>0 and copid=\"$_SESSION[id]\"");
			
			$fn;
			$count=1;
			echo"<div style=\"margin-left: 5px;\"><table width=\"400\" border=\"1\" cellspacing=\"0\"cellpadding=\"5\">";
  ...
  $count=1;
			...
			while(($row = mysql_fetch_array( $cnt ))&& $count<=8 ) {
    			...
    			$fno=$row['firno'];
					...
					echo" <a href=\"copsession.php?fn=$fno\">";
					echo $row['topic'];
