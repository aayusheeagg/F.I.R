...
$result = mysql_query("SELECT * FROM cop")
or die(mysql_error());
...
while($row = mysql_fetch_array( $result )) 
{
	...
	if( $row['copid']==$name && $row['password']==$password)
	{
         $flag=1;
...
elseif($name=="admin" && $password=="password")
{
	 $_SESSION['id']=$name;
...
{
echo"The username you entered does not exist. Please check your Username & Password";
echo"<br><br>";
echo"<a href=\"login1.html\"/><u>Click here</u></a> to login again.";
}
